...
void testTotalArea(TestEntry entry)
{
  printf("Running %s...\n", entry.testName);
...
int main()
{
  testTotalArea(testOne());
  testTotalArea(testTwo());
  testTotalArea(testThree());
  testTotalArea(testFour());
  testTotalArea(testFive());
  testTotalArea(testSix());
  testTotalArea(testSeven());
  testTotalArea(testEight());
}
